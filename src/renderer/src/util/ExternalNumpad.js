...
export default class ExternalNumpad {
    ...
    constructor() {
        ...
        this.commands = {
            ...
            'NumpadEnter': () => Jog.goToMachine(Constants.ParkPosition),
    ...
    async open() {
        window.addEventListener('keyup', event => {
            if (event.location === KeyboardEvent.DOM_KEY_LOCATION_NUMPAD || ['Backspace', 'NumLock', 'NumpadEnter'].includes(event.code)) {
